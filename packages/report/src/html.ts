...
its condition, because the model does not record the control it asks about, so tmc reports
...
<meta name="generator" content="tmc">
...
${toc}
  ...
  <p class="toc__foot">Generated by tmc</p>
</nav>
<main class="content">
...
<p>Generated by tmc${opts.modelPath ? ` from <code>${esc(opts.modelPath)}</code>` : ''} at
